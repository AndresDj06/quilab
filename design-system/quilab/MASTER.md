...
|------|-----|--------------|
| Primary | `#14111C` | `--color-primary` |
| On Primary | `#FFFBF3` | `--color-on-primary` |
| Secondary | `#1A3D3A` | `--color-secondary` |
| On Secondary | `#FFFFFF` | `--color-on-secondary` |
| Accent/CTA | `#D4A017` | `--color-accent` |
| On Accent/CTA | `#14111C` | `--color-on-accent` |
| Gold | `#E8C56A` | `--color-gold` |
| Teal | `#2EC4B6` | `--color-teal` |
| Background | `#F6F1E7` | `--color-background` |
| Foreground | `#14111C` | `--color-foreground` |
| Card | `#FFFBF5` | `--color-card` |
| Card Foreground | `#14111C` | `--color-card-foreground` |
| Muted | `#ECE3D4` | `--color-muted` |
| Muted Foreground | `#6B5E4E` | `--color-muted-foreground` |
| Border | `#E0D3BE` | `--color-border` |
| Destructive | `#DC2626` | `--color-destructive` |
| On Destructive | `#FFFFFF` | `--color-on-destructive` |
| Ring | `#D4A017` | `--color-ring` |
| Ink | `#09070F` | `--color-ink` |

**Color Notes:** Ink with indigo undertone, champagne gold, teal lens. Liquid glass surfaces on navigation and cards.
...
**Keywords:** optical glass, translucency, champagne gold, teal lens, fluid morphing, dynamic material, elegant contrast
